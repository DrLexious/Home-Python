...
# определенную ценность. В случае с английским алфавитом очки распределяются так: # A, E, I, O, U, L, N, S, T, R – 1 очко;
...
N = abs(int(input('Enter 1 if word in English / Введите 0, если в Русской раскладке: ')))
if N == 1:
